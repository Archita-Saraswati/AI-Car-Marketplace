...
export const AddCarForm = () => {
  ...
  const onSubmit = async (data) => {
    ...
    const carData = {
      ...
      // price: parseFloat(data.price), --u can give this
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                  ...
                  <div className="space-y-2">
                    ...
                    <Input
                      id="price"
                      {...register("price")}
                      placeholder="e.g. 25000 ( Please enter as specified format)"
                  ...
                  <div className="space-y-2">
                    ...
                    <Input
                      id="mileage"
                      {...register("mileage")}
                      placeholder="e.g. 15000 ( Please enter as specified format)"
